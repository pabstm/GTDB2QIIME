...
#ssu all
ssu_all_url=   "https://data.gtdb.ecogenomic.org/releases/latest/genomic_files_all/ssu_all.tar.gz"
...
#%% Script
download_extract(ssu_all_url,ssu_all_path)
download_extract(ssu_reps_urls,ssu_reps_path)
